...
WORKDIR /usr/src/app
RUN apt update && apt install git wget libxt6 libgl1-mesa-glx libdbus-glib-1-2 libgtk-3-0 lbzip2 -y && apt clean && git clone https://github.com/Pfuenzle/anime-loads.git
